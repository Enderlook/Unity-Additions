...
namespace Additions.Utils
{
    public static class AudioUtil
    {
        ...
        static AudioUtil()
        {
            ...
            T GetDelegate<T>(string name, params Type[] parameters) where T : Delegate => (T)CreateDelegate<T>(audioUtilClass.GetMethod(name, bindingFlags, null, parameters, null));
