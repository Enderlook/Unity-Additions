                    ...
                    if (isRangeObject)
                    {
                        ...
                        switch (min.propertyType)
                        {
                            ...
                            case SerializedPropertyType.Integer:
                                ...
                                break;
                            default:
                                ShowError(position, error + $" Property {MIN_FIELD_NAME}, {MAX_FIELD_NAME}, and {Unity.Serializables.Ranges.RangeDrawer.STEP_FIELD_NAME} of {serializedProperty.name} are {serializedProperty.propertyType}.");
                                break;
                        }
                    }
                    else
