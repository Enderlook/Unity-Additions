...
using Enderlook.Unity.Utils.ColorCombiner;
...
namespace Enderlook.Unity.Components.ColorCombiner
{
    [AddComponentMenu("Enderlook/Color Combiner/Sprite Renderer Colorer With Timer")]
