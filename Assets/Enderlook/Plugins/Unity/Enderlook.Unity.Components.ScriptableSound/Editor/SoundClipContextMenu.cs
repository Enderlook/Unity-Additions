...
namespace Enderlook.Unity.Components.ScriptableSound
{
    ...
    {
        [MenuItem("Assets/Enderlook/Scriptable Sound/Sound Clip/Create")]
        ...
        [MenuItem("Assets/Enderlook/Scriptable Sound/Create Sound Clip", true), MenuItem("Assets/Enderlook/Scriptable Sound/Sound Clip/Create all in a single asset", true)]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Code Quality", "IDE0051:Remove unused private members", Justification = "Used by Unity.")]
