...
namespace Enderlook.Unity.Components.ScriptableSound
{
    ...
    {
        [MenuItem("Assets/Enderlook/Scriptable Sound/Sound List/Create from SoundClips")]
        ...
        [MenuItem("Assets/Enderlook/Scriptable Sound/Create Sound List", true)]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Code Quality", "IDE0051:Remove unused private members", Justification = "Used by Unity.")]
        ...
        [MenuItem("Assets/Enderlook/Scriptable Sound/Sound List/Create from AudioClips")]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Code Quality", "IDE0051:Remove unused private members", Justification = "Used by Unity.")]
        ...
        [MenuItem("Assets/Enderlook/Scriptable Sound/Sound List/Create from AudioClips", true)]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Code Quality", "IDE0051:Remove unused private members", Justification = "Used by Unity.")]
        ...
        [MenuItem("Assets/Enderlook/Scriptable Sound/Sound List/Create from AudioClips and SoundClips", true)]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Code Quality", "IDE0051:Remove unused private members", Justification = "Used by Unity.")]
        ...
        [MenuItem("Assets/Enderlook/Scriptable Sound/Sound List/Create from AudioClips and SoundClips", true)]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Code Quality", "IDE0051:Remove unused private members", Justification = "Used by Unity.")]
        private static bool CreateSoundListFromAudioClipsAndSoundClipsValidation()
